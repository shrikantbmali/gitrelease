...
namespace gitrelease.cli
{
    class Program
    {
        static int Main(string[] args)
        {
            ...
            {
                Handler = CommandHandler.Create((IConsole console, CancellationToken token) => (int)Init(console, token))
            };
        ...
        private static ReleaseManagerFlags Init(IConsole console, CancellationToken token)
        {
            try
            {
